...
_REGISTRY = {
    ...
    "iss_voice": {
        "id": "iss_voice",
        "label": "ISS Voice",
        "description": "Geplande ISS-spraakontvangst met flexibele receiver assignment.",
    ...
    "traffic_voice": {
        ...
        "receiver_type": "rtl_sdr",
        "executor": "service",
        "services": ["sdrcc-traffic-voice.service"],
        "handover_services": ["sdrcc-traffic-voice.service"],
        "capabilities": [
            "audio_receive",
            "channel_scan",
            "channel_activity",
