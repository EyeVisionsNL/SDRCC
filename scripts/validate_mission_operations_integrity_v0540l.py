...
def validate_static_contract() -> None:
    ...
    check(
        ...
        and any(version in template for version in ('/static/dashboard.js?v=0.54.0l-r1', '/static/dashboard.js?v=0.54.0m-r1', '/static/dashboard.js?v=0.54.0n-r1'))
        and any(version in dashboard_loader for version in ('/static/js/dashboard.js?v=0.54.0l-r1', '/static/js/dashboard.js?v=0.54.0m-r1', '/static/js/dashboard.js?v=0.54.0n-r1'))
