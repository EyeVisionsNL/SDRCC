...
check("receiver_manager.begin_handover" in source, "Receiver Manager owns reservation and handover")
check("receiver_manager.restore_handover" in source, "receiver context is restored in finally")
